...
originals ='https://api.themoviedb.org/3/discover/tv?api_key={API_KEY_HERE}'

action ='https://api.themoviedb.org/3/discover/movie?api_key={API_KEY_HERE}'

top-rated = 'https://api.themoviedb.org/3/discover/movie/top_rated?api_key={API_KEY_HERE}'